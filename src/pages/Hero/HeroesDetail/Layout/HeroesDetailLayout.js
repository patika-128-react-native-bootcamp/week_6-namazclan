...
export default function HeroesDetailLayout({
  data,
  theme,
  visible,
  setVisible,
      ...
      <ImageBackground
        ...
        <View style={styles[theme].row}>
          <TouchableOpacity
            ...
            onPress={() => handleSelect('Wiki')}>
            <Icon name="file-chart" size={30} color={iconColor} />
            <Text style={styles[theme].subTitle}>Wiki</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles[theme].buttonContainer}
            onPress={() => handleSelect('Comics')}>
            <Icon name="book" size={30} color={iconColor} />
            <Text style={styles[theme].subTitle}>Comics</Text>
          </TouchableOpacity>
        </View>
        <ModalCard
          visible={visible}
